...
<div x-data="{ open: false }" class="relative h-screen sm:hidden" @click.away="open = false">
    <div :class="open ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex flex-col gap-6">
            ...
            <a href="/forum">
                <div class="tooltip tooltip-right" data-tip="Forum">
                    <button
                        class="hover:bg-[#E3ECF1] hover:scale-[102%] flex items-center justify-center duration-300  rounded-full w-14 h-14">
    ...
    <button @click="open = !open"
        class="absolute z-50 top-14 left-8 transform -translate-y-1/2 bg-white rounded-full p-3 hover:scale-105 duration-150">
