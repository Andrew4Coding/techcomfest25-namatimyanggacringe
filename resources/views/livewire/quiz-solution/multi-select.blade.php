    ...
    {{ $submissionItem->answer }}
        ...
        >
            <div
                ...
                @elseif($isCorrect && !$isSelected) bg-green-50 border border-green-300 rounded
                @endif
                p-2"
            >
                <input
                ...
                <label for="answer-{{ $choice->id }}" class="text-gray-700 text-lg cursor-pointer flex items-center">
                    ...
                    @if($isCorrect)
                        @if($isSelected)
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-500 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            <span class="text-green-600 ml-1">Benar</span>
                        @else
                            {{-- Jawaban Benar tapi Tidak Dipilih --}}
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-300 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
