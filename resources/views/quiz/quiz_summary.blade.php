...
@section('content')
    <div class="w-full h-full flex justify-center items-center">
        <div class="p-4 rounded-xl shadow-xl flex flex-col gap justify-between items-center">
            ...
            <div class="p-4 rounded-xl bg-blue-500 flex flex-col text-sm text-white gap-2">
                <span class="flex gap-2 items-center">
                    ...
                    Mulai: {{ \Carbon\Carbon::parse($quiz->start)->format('d M Y, H:i') }}
                </span>
                <span class="flex gap-2 items-center">
                    <x-lucide-timer class="w-4 h-4" />
                    Berakhir: {{ \Carbon\Carbon::parse($quiz->finish)->format('d M Y, H:i') }}
                </span>
                <span class="flex gap-2 items-center">
