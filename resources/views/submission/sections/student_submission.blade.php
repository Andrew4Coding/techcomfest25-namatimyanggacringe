...
@if ($submissionItem)
    <section class="mb-10">
        <h3 class="font-semibold text-xl text-gray-800 mb-4">Submission Status</h3>
        <p class="text-gray-600">Check your submission status.</p>
    ...
    @if ($canSubmit)
        <section class="mb-10">
            <h3 class="font-semibold text-xl text-gray-800 mb-4">Number of Attempts</h3>
            <p class="text-gray-600">You have tried to submit {{ $submissionItem->attempts ?? 0 }} /
...
<!-- Submit Your Work -->
<section class="mb-10">
    <h3 class="font-semibold text-xl text-gray-800 mb-4">Submit Your Work</h3>
    @if ($canSubmit)
        <form action="{{ route('submission.submit', $submission->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="flex flex-col items-start gap-2">
                ...
                <input required type="file" name="file" id="submission_file" accept=".pdf,.zip"
                    class="file-input file-input-primary p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
            <button type="submit"
                class="btn btn-primary bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600">
...
@if ($submissionItem)
    <!-- Grade and Comments -->
    <section class="mb-10">
        <h3 class="font-semibold text-xl text-gray-800 mb-4">Grade and Comments</h3>
        <div class="flex flex-col gap-4">
            <div class="flex items-center">
                <b class="text-gray-700 mr-2">Grade:</b>
                @if ($submissionItem)
                    <p
                        class="@if ($submissionItem->grade > 80) text-green-500 @elseif($submissionItem->grade > 60) text-orange-500 @elseif($submissionItem->grade > 50) text-yellow-500 @else text-red-500 @endif">
